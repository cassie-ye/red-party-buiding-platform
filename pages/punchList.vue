...
<template>
    <div>
        ...
        <div class="m0.5rem bg-#fff p0.5rem rounded-0.5rem pl1rem pr1rem font-size-0.9rem
        flex justify-between items-center
        ">
            <div>
                <p>打卡时间：<span class="font-bold">2024-11-23</span></p>
                <p class="mt0.1rem">基地地址：<span class="font-bold">宁波市四明山国家公园</span></p>
