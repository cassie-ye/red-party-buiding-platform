    ...
    <div class="bg-#fff ">
        ...
        <div class="p1rem ">
            ...
            <el-timeline style="max-width: 38rem;margin-top: 0.5rem;">
                <el-timeline-item v-for="i in 10" timestamp="2024/09" placement="top" size="large" color="#1CD5C7">
                    <el-card v-for="i in dakaList" :key="i" class="mb0.5rem relative"
                        :style="{ backgroundColor: getRandomBrightColor() }">
                        <div class="flex justify-between">
                            <div>
                                <div class="flex items-center">
                                    <i class=" iconfont icon-dizhi font-size-1.2rem mr0.5rem"></i>
                                    <p class="">打卡地点：{{ i.area }}</p>
                                </div>
                                <div class="flex items-center">
