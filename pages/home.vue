...
<template>
    <div class="top-red-linear-bg w-full h20rem bg-red pl0.5rem pr0.5rem pt1rem">
        <!-- 头部搜索框 客服  更多-->
        ...
        ">
            <div v-for="(item, index) in moudleList" :key="index"
        ...
        <van-swipe class="swipe mt0.5rem rounded-0.3rem" :autoplay="3000" indicator-color="white">
            <van-swipe-item>
                <img class="w-full h-4.5rem" src="http://www.crt.com.cn/news2007/Templets/2012images/hs2012_03.jpg" alt="">
            </van-swipe-item>
            <van-swipe-item>
                <img class="w-full h-4.5rem" src="http://www.crt.com.cn/news2007/Templets/2012images/hs2012_04.jpg" alt="">
            </van-swipe-item>
            <van-swipe-item>
                <img class="w-full h-4.5rem" src="http://www.crt.com.cn/news2007/Templets/2012images/hs2012_07.jpg" alt="">
            </van-swipe-item>
            <van-swipe-item>
                <img class="w-full h-4.5rem" src="http://www.crt.com.cn/news2007/Templets/2012images/hs2012_12.jpg" alt="">
            </van-swipe-item>
        </van-swipe>
    </div>
